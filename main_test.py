...
if __name__ == '__main__':
    ...
    model_name = f'outputs/{args.dataset}/{args.dynamic}{args.TET}{args.cut}/{args.dataset}_resnet19_T{args.T}_dyn{args.dynamic}_TET{args.TET}_seed{args.seed}_cut{args.cut}_batch{args.batch_size}'
    file_name = f'outputs/{args.dataset}/{args.dynamic}{args.TET}{args.cut}/out_dyn_{args.dynamic}_TET_{args.TET}_Cut_{args.cut}_batch{args.batch_size}'

    # for lat in range(1,args.T+1):
    #     save_name = model_name + f'_test{lat}.pth'
    #     fname = file_name + f'_test{lat}.txt'
    ...
    #             file.write(f'Test accuracy at t={t} is {acc}\n')
